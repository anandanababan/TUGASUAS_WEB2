    ...
    <div class="col-md-12">
        ...
        <div class="card shadow mb-4 nt-3">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Rekapitulasi Mahasiswa</h6>
            </div>
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            $tampil = mysqli_query($koneksi, "SELECT * FROM mahasiswa WHERE tanggal BETWEEN '$tgl1' AND '$tgl2' ORDER BY id DESC");
                            $no = 1;
                     ...
                     <center>
                        <form method="POST"action="exportexcel.php">
                            <div class="col-md-4"><input type="hidden"name="tanggala"value="<?=@$_POST['tanggal1']?>">
